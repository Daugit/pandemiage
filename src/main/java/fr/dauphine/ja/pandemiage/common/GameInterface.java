...
/**
 * Interface to the engine given to the AI for getting information to the status
 * of the game
 *
 */
...
public interface GameInterface {
	...
	/**
	 * 
	 * @return the current infection rate of this game (2, 3 or 4), depending of the
	 *         number of epidemies already occured.
	 */
	public int infectionRate();

	/**
	 * 
	 * @return The maximum turn duration in seconds before the engine sends a
	 *         interrupt flag
	 */
	...
	/**
	 * Once played, infection cards are discarded but player can check what was
	 * discarded. This method allows to get the list of discarded cards that will be
	 * back in the deck during an epidemic.
	 * 
