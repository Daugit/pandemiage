...
public interface AiInterface {
	...
	/**
	 * Engines call this method. AI should play the 4 actions in this method within
	 * the time fixed in TurnDuration. Engines put the interrupt flag to true after
	 * this time. AI should check this flag. If AI didn't finished this method 1
	 * second after the first timeout, the game is lost.
	 * 
	...
	/**
	 * Once the player finished its actions and received Player Cards, he must
	 * discards to fit to the maximum hand size
	 * 
	 * @param g               Interface with the game
	 * @param p               Interface with the actions
	 * @param maxHandSize     maximum size of the player hand
	 * @param nbEpidemicCards number of epidemic cards that were picked by the
